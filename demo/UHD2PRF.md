---
title: "XYZ Ultra High Density Two Port Register File User Manual"
toc-title: "Contents"
---
...
This chapter provides an overview of the embedded memories of Ultra High Density Two Port Register File memory compiler.
...
+----------------+-----------------------------+--------------------+
| Name Segment   | Character in "XYZUHD2PRF"   | Description        |
+================+=============================+====================+
...
+-----------------+---------------------------------------------+
| Compiler Name   | Ultra High Density Two Port Register File   |
+=================+=============================================+
| LVT             | Low                                         |
+-----------------+---------------------------------------------+
| ULVT            | UltraLow                                    |
...
![Column Redundancy Replace Mechanism](../Template/SC/V02/Figure\Ultra High Density Two Port Register File\Column_Redundancy_replace_mechanism.png)
...
![Column Redundancy Waveform](../Template/SC/V02/Figure\Ultra High Density Two Port Register File\1_Column_redundancy.png)
...
The specifications of Ultra High Density Two Port Register File.
...
+------------+-------+--------+--------+---------+---------+------+------------+
| Function   | CLK   | CENA   | CENB   | BWENA   | DA      | QB   | Memory\    |
|            |       |        |        |         |         |      | Contents   |
+============+=======+========+========+=========+=========+======+============+
| Idle       | L     | X      | X      | X       | X       | Q-1  | NCM        |
+------------+-------+--------+--------+---------+---------+------+------------+
| Disabled   | H     | H      | H      | X       | X       | Q-1  | NCM        |
+------------+-------+--------+--------+---------+---------+------+------------+
| Read       | H     | H      | L      | H       | X       | Q    | NCM        |
+------------+-------+--------+--------+---------+---------+------+------------+
| Write      | H     | L      | H      | L       | Data-in | Q-1  | Data-in    |
+------------+-------+--------+--------+---------+---------+------+------------+
| Write Mask | H     | L      | H      | H       | X       | Q-1  | NCM        |
+------------+-------+--------+--------+---------+---------+------+------------+
...
![Waveform Conventions](../Template/SC/V02/Figure\Ultra High Density Two Port Register File\waveform_conventions.png)



![Read Cycle Timing Diagram](../Template/SC/V02/Figure\Ultra High Density Two Port Register File\read_cycle_timing_diagram.png)




![Write Cycle Timing Diagram](../Template/SC/V02/Figure\Ultra High Density Two Port Register File\write_cycle_timing_diagram.png)



![Light Sleep Mode Work Function Diagram](../Template/SC/V02/Figure\Ultra High Density Two Port Register File\light_sleep_mode_work_function_diagram.png)




![Deep Sleep Mode Work Function Diagram](../Template/SC/V02/Figure\Ultra High Density Two Port Register File\deep_sleep_mode_work_function_diagram.png)




![Shut Down Mode Work Function Diagram](../Template/SC/V02/Figure\Ultra High Density Two Port Register File\shut_down_mode_work_function_diagram.png)
